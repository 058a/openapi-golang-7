...
import (
	item "openapi/internal/domain/stock/item"
	reflect "reflect"
...
func (m *MockIRepository) Find(id item.Id) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockIRepository) Get(id item.Id) (*item.Aggregate, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(*item.Aggregate)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIRepository) Save(a *item.Aggregate) error {
	m.ctrl.T.Helper()
